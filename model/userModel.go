...
// 获取多行数据.
func (m *UserModel) getRows(ctx context.Context, sqlTxt string, params ...interface{}) (rowsResult []*User, err error) {
...
//获取单行
func (m *UserModel) getRow(ctx context.Context, db *sql.DB, sqlText string, params ...interface{}) (rowResult *User, err error) {
...
// 保存数据
func (m *UserModel) Save(ctx context.Context, sqlTxt string, value ...interface{}) (b bool, err error) {
...
// _更新数据Tx
func (m *UserModel) SaveTx(ctx context.Context, tx *sql.Tx, sqlTxt string, value ...interface{}) (b bool, err error) {
...
// 获取单行数据
func (m *UserModel) Find(ctx context.Context, id ...int64) (result []*User, err error) {
...
// 更新数据
func (m *UserModel) Update(ctx context.Context) (b bool, err error) {
